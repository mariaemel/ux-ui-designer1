...
label chapter2:
    ...
    hide anna
    hide margo
    "Марго повела Анну по своим любимым магазинам, где они нашли много новой одежды для Анны."
    show anna normal at left2
    show margo normal at right2
...
label chapter3Cont:
    ...
    Anna "Но все эти молоко, яйца, хлеб, овощи... Откуда они берутся? Как они сюда попадают?"
    Margo normal "Это все происходит благодаря сельскому хозяйству и производителям, которые выращивают и производят все эти продукты. Затем они доставляются в магазины."
    Anna "Интересно, а как они устанавливают эти цены? Здесь же столько разных товаров."
    Margo "Цены обычно зависят от множества факторов, таких как стоимость производства, себестоимость, налоги, а также конкуренция на рынке. Также магазины часто делают скидки и проводят акции для привлечения клиентов."
    Anna "Все это звучит сложно, но так интересно! Я никогда бы не подумала, что во всех этих простых и обычных вещах стоит так много труда и усилий."
    Margo "Да, Анна, магазины – это целые организации, в которых работает множество людей, чтобы удовлетворять наши потребности."
    Margo "Теперь ты можешь лучше понять, как все устроено и почему товары, которые мы так легко покупаем, на самом деле являются результатом многолетних усилий людей."
    Anna "Удивительно! Спасибо тебе, Марго, что рассказала мне все это."
    Margo smile "Пока ты всему удивлялась, я уже набрала полную тележку продуктов, пойдем на кассу."
    Anna "Пойдём."
...
label agree:
    ...
    Raphael smile "..."
    Anna "..."
    Raphael normal "Мне кажется, тебе уже пора спать, чтобы выспаться."
    Anna embarrassment "Спасибо, что заботишься обо мне. Это мило. "
    hide anna
    hide raphael
